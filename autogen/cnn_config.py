...
from .accelerator_api import DCACHE_BASE


ROOT = Path(__file__).resolve().parents[1]
PYTHON_DIR = ROOT / "python"
DATA_DIR = PYTHON_DIR / "data"
OUT_DIR = ROOT / "autogen" / "out"
...
DEFAULT_RISCV_GCC = DEFAULT_TOOLCHAIN_ROOT / "bin" / "riscv-none-elf-gcc"
DEFAULT_RISCV_OBJDUMP = DEFAULT_TOOLCHAIN_ROOT / "bin" / "riscv-none-elf-objdump"
DEFAULT_RISCV_OBJCOPY = DEFAULT_TOOLCHAIN_ROOT / "bin" / "riscv-none-elf-objcopy"
