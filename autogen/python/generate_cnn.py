...
from autogen.python.cnn_config import DMA_WAIT_NOPS, OUT_ASM, OUT_DCACHE_HEX, OUT_ICACHE_HEX, ROOT, testcase_paths
from autogen.python.cnn_model import load_cnn_tensors
from autogen.python.cnn_rodata import build_rodata
from autogen.python.memory_image import build_memory_images, write_hex_image
...
def main() -> None:
    ...
    print("run python3 autogen/compiler/build_current_cnn.py to refresh compiler workflow outputs")
    print("run python3 autogen/python/verify_cnn.py for manual workflow checks")
